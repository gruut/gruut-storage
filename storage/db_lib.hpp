...
public:
  ...
  // for money transfer
  int transferMoney(string fromUserId, string fromVarType, string fromVarName, string toUserId, string toVarType, string toVarName,
                    int value) {
    return 0;
  }
  ...
  int blockDelete(string blockId, string blockHash) {
    return 0;
  }
