...
struct UnresolvedBlock {
  ...
  UnresolvedBlock(Block &block_, int prev_queue_idx_) : block(block_), prev_block_vector_idx(prev_queue_idx_) {}
};
...
private:
  ...
  StateMerkleTree m_user_state_tree; // state tree
...
public:
  ...
  void setPool(const block_id_type &last_block_id, const block_id_type &prev_block_id, const hash_t &last_hash, const hash_t &prev_hash,
